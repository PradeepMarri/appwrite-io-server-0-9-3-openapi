...
func StoragegetfileHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateStoragegetfileTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_storage_files_fileId",
	...
	return models.Tool{
		Definition: tool,
		Handler:    StoragegetfileHandler(cfg),
	}
}
