...
func FunctionsdeletetagHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateFunctionsdeletetagTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_functions_functionId_tags_tagId",
	...
	return models.Tool{
		Definition: tool,
		Handler:    FunctionsdeletetagHandler(cfg),
	}
}
