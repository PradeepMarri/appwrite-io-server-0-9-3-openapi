...
func UsersgetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateUsersgetTool(cfg *config.APIConfig) models.Tool {
